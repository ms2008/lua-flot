...
<html>
 <head>
    ...
    <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="%sjs/excanvas.min.js"></script><![endif]-->
    <script language="javascript" type="text/javascript" src="%sjs/jquery.js"></script>
    <script language="javascript" type="text/javascript" src="%sjs/jquery.flot.js"></script>
    <script language="javascript" type="text/javascript" src="js/jquery.flot.crosshair.js"></script>
    <script language="javascript" type="text/javascript" src="js/jquery.flot.tooltip.js"></script>
 </head>
    <body>
]]
